...
import { Linkedin, Newspaper, CalendarDays, Settings as SettingsIcon, LayoutDashboard, Search, Library } from "lucide-react";
...
const tabs = [
  ...
  { to: "/social/content-studio", label: "Content Studio", icon: Library },
